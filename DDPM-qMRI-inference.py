# -*- coding: utf-8 -*-
"""
DDPM for Quantitative MRI Parameter Estimation (PD and T1 Mapping)
==================================================================

This script demonstrates the use of a Denoising Diffusion Probabilistic Model
(DDPM) with MONAI and PyTorch for solving inverse problems in quantitative MRI.
It performs inference on a test dataset and visualizes/exports the estimated
Proton Density (PD) and T1 maps.

Author: Erwin Dijkstra & Shishuai Wang
